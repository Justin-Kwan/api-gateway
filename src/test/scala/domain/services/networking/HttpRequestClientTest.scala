...
final class HttpRequestClientTest
      extends FunSpec
      with BeforeAndAfterEach {

  final val MOCK_GET_RESPONSE1 =
    "{\"mockResponse: \": \"get\"}"
  final val MOCK_GET_RESPONSE2 =
    "{\"mockResponse: \": \"get\", \"mockUrl: \": \"mockurl.com\"}"

  final val MOCK_POST_RESPONSE1 =
    "{\"mockResponse: \": \"post\"}"
  final val MOCK_POST_RESPONSE2 =
    "{\"mockResponse: \": \"post\", \"mockUrl: \": \"mockurl.com\"}"

  final val MOCK_PUT_RESPONSE1 =
    "{\"mockResponse: \": \"put\"}"
  final val MOCK_PUT_RESPONSE2 =
    "{\"mockResponse: \": \"put\", \"mockUrl: \": \"mockurl.com\"}"

  final val MOCK_PATCH_RESPONSE1 =
    "{\"mockResponse: \": \"patch\"}"
  final val MOCK_PATCH_RESPONSE2 =
    "{\"mockResponse: \": \"patch\", \"mockUrl: \": \"mockurl.com\"}"

  final val MOCK_DELETE_RESPONSE1 =
    "{\"mockResponse: \": \"delete\"}"
  final val MOCK_DELETE_RESPONSE2 =
    "{\"mockResponse: \": \"delete\", \"mockUrl: \": \"mockurl.com\"}"

  // mock request bodies
  final val mockRequestBody1 =
    "{\"mockRequest: \": \"mock request data\"}"
  final val mockRequestBody2 =
    "{\"mockRequest: \": \"mock request data\", \"info: \": \"mock\"}"

  // mock request error responses
  final val CONNECTION_TIMEOUT_RESPONSE =
    "{ Downstream service connection timeout }"
  final val CONNECTION_REFUSED_RESPONSE =
  ...
  private def configMockServerDeleteResponse(mockResponse: String, delay: Int): Unit = {
    this.mockServer.stubFor(delete(urlPathEqualTo(
      MOCK_PATH + MOCK_DELETE_RESOURCE
    ))
    .willReturn(aResponse()
    .withHeader("Content-Type", "application/json")
    .withBody(mockResponse)
  ...
  describe("makeGetRequest() tests") {
    it("should make get request with mockResponse1") {
      this.configMockServerGetResponse(
        this.MOCK_GET_RESPONSE1,
        this.SHORT_DELAY
      )
  ...
  describe("makeDeleteRequest() tests") {
    it("should make delete request with mockResponse1") {
      this.configMockServerDeleteResponse(
        this.MOCK_DELETE_RESPONSE1,
        this.SHORT_DELAY
      )
      val response = HttpRequestClient.makeDeleteRequest(
        MOCK_URL + MOCK_DELETE_RESOURCE
      )
  ...
  describe("makePostRequest() tests") {
    it("should make post request with mockResponse1") {
      this.configMockServerPostResponse(
        mockRequestBody1,
        this.MOCK_POST_RESPONSE1,
        this.SHORT_DELAY
      )
      val response = HttpRequestClient.makePostRequest(
        MOCK_URL,
        mockRequestBody1
      )
  ...
  describe("makePutRequest() tests") {
    it("should make put request with mockResponse1") {
      this.configMockServerPutResponse(
        mockRequestBody1,
        this.MOCK_PUT_RESPONSE1,
        this.SHORT_DELAY
      )
      val response = HttpRequestClient.makePutRequest(
        MOCK_URL,
        mockRequestBody1
      )
  ...
  describe("makePatchRequest() tests") {
    it("should make patch request with mockResponse1") {
      this.configMockServerPatchResponse(
        mockRequestBody1,
        this.MOCK_PATCH_RESPONSE1,
        this.SHORT_DELAY
      )
      val response = HttpRequestClient.makePatchRequest(
        MOCK_URL,
        mockRequestBody1
      )
  ...
  describe("getRequestFunc() tests") {
    it("should get a makeGetRequest function (asserting function's response)") {
      ...
      val requestFunc: (String, String) => String =
        HttpRequestClient.getRequestFunc("get")
    ...
    it("should get makeDeleteRequest function (asserting function's response)") {
      ...
      val requestFunc: (String, String) => String =
        HttpRequestClient.getRequestFunc("delete")
    ...
    it("should get makePostRequest function (asserting function's response)") {
      ...
      val requestFunc: (String, String) => String =
        HttpRequestClient.getRequestFunc("post")
    ...
    it("should get makePutRequest function (asserting function's response)") {
      ...
      val requestFunc: (String, String) => String =
        HttpRequestClient.getRequestFunc("put")
      val response = requestFunc(MOCK_URL, mockRequestBody1)
      assert(response == this.MOCK_PUT_RESPONSE1)
    }
    ...
    it("should get makePatchRequest function (asserting function's response)") {
      ...
      val requestFunc: (String, String) => String =
        HttpRequestClient.getRequestFunc("patch")
      val response = requestFunc(MOCK_URL, mockRequestBody1)
      assert(response == this.MOCK_PATCH_RESPONSE1)
    }
  }
